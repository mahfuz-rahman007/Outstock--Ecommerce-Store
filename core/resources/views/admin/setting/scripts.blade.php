            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form id="slink" class="form-horizontal" action="{{ route('admin.updateScript') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group row mt-5">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="checkbox" {{ $commonsetting->is_messenger == '1' ? 'checked' : '' }} data-size="large" name="is_messenger" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="Active" data-label-text="<i class='fas fa-mouse'></i>"  data-off-text="Deactive">
