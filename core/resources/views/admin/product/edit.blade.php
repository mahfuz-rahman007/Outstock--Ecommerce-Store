                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.product.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number"  step="any" class="form-control" name="current_price" placeholder="{{ __('Current Price') }}" value="{{ $product->current_price }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number"  step="any" class="form-control" name="previous_price" placeholder="{{ __('Previous Price') }}" value="{{ $product->previous_price }}">
